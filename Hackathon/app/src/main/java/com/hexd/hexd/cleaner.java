    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener onClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (btn.getId()){
                    case R.id.button8:
                        Intent app = new Intent(cleaner.this,StatisticsMap.class);
                        startActivity(app);
                        break;

                    case R.id.button9:
                        Intent app1 = new Intent(cleaner.this,StatisticsMap.class);
                        startActivity(app1);
                        break;

                    case R.id.button10:
                        Intent app2 = new Intent(cleaner.this,StatisticsMap.class);
                        startActivity(app2);
                        break;

                    case R.id.button11:
                        Intent app3 = new Intent(cleaner.this,StatisticsMap.class);
                        startActivity(app3);
                        break;

                    case R.id.button12:
                        Intent app4 = new Intent(cleaner.this,StatisticsMap.class);
                        startActivity(app4);
                        break;

                    case R.id.button13:
                        Intent app5 = new Intent(cleaner.this,otherpage.class);
                        startActivity(app5);
                        break;
